...
struct Car
{
	...
	char* (*transmission_str)(struct Car* self);

	void (*change_color)(struct Car* self, char* changed_color);

	void (*change_transmission)(struct Car* self, char* transmission_type);

	void (*clear)(struct Car* self);

	void (*transmission_swap)(struct Car* self);
};
...
// ej klar försök att skriva ut i main.c utan växellåda
